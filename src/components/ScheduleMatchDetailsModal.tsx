            ...
            <div className="p-6 space-y-6 flex-1">
              {isFT && (
                <div>
                  ...
                  <div className="text-sm leading-relaxed text-gray-300 bg-[#0b0f19] p-4 border border-[#1e293b] rounded-xl shadow-inner space-y-3">
                    <p>
                      <strong>{match.home} {match.homeScore} - {match.awayScore} {match.away}</strong>. 
                      An intense battle that concluded with {homeScoreNum > awayScoreNum ? match.home : awayScoreNum > homeScoreNum ? match.away : 'a hard-fought draw'}.
                    </p>
